...
export const createEditValidators = (t: TranslationFunction) => {
  // Base validators with translation for personalInfo
  // Identity Form
  ...
  // Function to create partial validation schema based on modified fields
  const createPartialSchema = (section: SectionType): z.ZodTypeAny => {
    switch (section) {
      case 'personalInfo':
        return z.object(personalInfoValidators);
      case 'education':
