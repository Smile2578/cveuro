...
const CVDocument = memo(({ data, locale }) => {
  ...
  const getLanguageChipStyle = (proficiency) => {
      ...
      <Document>
        <Page size="A4" style={styles.page}>
          ...
          <View style={styles.header}>
            ...
            {/* Nationalité */}
            {data?.personalInfo?.nationality?.length > 0 && (
                ...
                <View style={[styles.section, { breakInside: 'avoid', pageBreakInside: 'avoid' }]} wrap={false}>
                  <View style={[styles.sectionContent, { breakInside: 'avoid', pageBreakInside: 'avoid' }]}>
                    ...
                    {data.workExperience.map((exp, index) => (
                      <View key={index} style={[styles.experienceItem, { breakInside: 'avoid', pageBreakInside: 'avoid' }]}>
                        <View style={styles.experienceHeader}>
                          <View style={styles.experienceContent}>
